...
func (x *StoreMessageRequest) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *StoreMessageRequest) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
var file_dkvs_message_message_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x16, 0x0a, 0x14, 0x53, 0x74, 0x6f,
...
var file_dkvs_message_message_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
