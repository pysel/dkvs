...
var file_dkvs_balancer_rpc_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xbe, 0x02, 0x0a, 0x0f, 0x42, 0x61, 0x6c, 0x61,
	0x6e, 0x63, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3c, 0x0a, 0x03, 0x47,
	0x65, 0x74, 0x12, 0x18, 0x2e, 0x64, 0x6b, 0x76, 0x73, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x2e, 0x47, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x19, 0x2e, 0x64,
	0x6b, 0x76, 0x73, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x47, 0x65, 0x74, 0x52,
	...
	0x53, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x19, 0x2e, 0x64, 0x6b, 0x76,
	0x73, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x53, 0x65, 0x74, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x45, 0x0a, 0x06, 0x44, 0x65, 0x6c, 0x65, 0x74,
	0x65, 0x12, 0x1b, 0x2e, 0x64, 0x6b, 0x76, 0x73, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	...
	0x0a, 0x11, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x50, 0x61, 0x72, 0x74, 0x69, 0x74,
	0x69, 0x6f, 0x6e, 0x12, 0x27, 0x2e, 0x64, 0x6b, 0x76, 0x73, 0x2e, 0x62, 0x61, 0x6c, 0x61, 0x6e,
	0x63, 0x65, 0x72, 0x2e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x50, 0x61, 0x72, 0x74,
	0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x28, 0x2e, 0x64,
...
var file_dkvs_balancer_rpc_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dkvs_balancer_rpc_proto_goTypes = []interface{}{
	...
	(*prototypes.GetRequest)(nil),     // 2: dkvs.message.GetRequest
	(*prototypes.SetRequest)(nil),     // 3: dkvs.message.SetRequest
	(*prototypes.DeleteRequest)(nil),  // 4: dkvs.message.DeleteRequest
	(*prototypes.GetResponse)(nil),    // 5: dkvs.message.GetResponse
	(*prototypes.SetResponse)(nil),    // 6: dkvs.message.SetResponse
	(*prototypes.DeleteResponse)(nil), // 7: dkvs.message.DeleteResponse
}
var file_dkvs_balancer_rpc_proto_depIdxs = []int32{
	2, // 0: dkvs.balancer.BalancerService.Get:input_type -> dkvs.message.GetRequest
	3, // 1: dkvs.balancer.BalancerService.Set:input_type -> dkvs.message.SetRequest
	4, // 2: dkvs.balancer.BalancerService.Delete:input_type -> dkvs.message.DeleteRequest
	0, // 3: dkvs.balancer.BalancerService.RegisterPartition:input_type -> dkvs.balancer.RegisterPartitionRequest
	5, // 4: dkvs.balancer.BalancerService.Get:output_type -> dkvs.message.GetResponse
	6, // 5: dkvs.balancer.BalancerService.Set:output_type -> dkvs.message.SetResponse
	7, // 6: dkvs.balancer.BalancerService.Delete:output_type -> dkvs.message.DeleteResponse
